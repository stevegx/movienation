      ...
      <div className='bg-neutral-900 text-zinc-50 w-screen h-screen overflow-x-hidden scroll-smooth flex'>
        <div className='flex-col'>
          ...
          <div className='flex my-3 justify-center text-gray-400'>
            <h2 className='mx-3'>{moviePage.certification}-rated</h2>
            ...
            <div className='flex flex-wrap gap-4 justify-center  my-3'>
              ...
              <div className='flex gap-1'>
                ...
                <div className='flex px-20 my-10 justify-center items-center'>
                <img className='w-2/6 h-1/6 rounded-xl' src={image+moviePage.poster_path}alt={moviePage.title} />
                <div className='flex-col m-5'>
                <h1 className='text-center text-3xl mb-10'>"{moviePage.tagline}"</h1>
                ...
                <div className='flex gap-3 justify-center text-l '>
                  ...
                  <h1 className='mx-1.5'>Director: <span className='text-blue-500'>{moviePage.directors.name}</span></h1>
                  <h1>Cast:</h1>
              ...
              return(
                ...
                <div className='flex justify-center px-10 mx-7 m-3'>
                <h1>Writters:</h1>
              ...
              return(
                ...
                <div className='flex text-2xl gap-2 absolute right-0 bottom-0 m-5'>
